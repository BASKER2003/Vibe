...
# Load dataset
career = pd.read_csv(r'Dataset/FT.data')
...
career.columns = [
    ...
    "Fashion Styling",
    "Fashion Technology Project Management",
    "Garment Construction",
    "Pattern Making",
    "Fashion Product Management",
    "Quality Control in Fashion",
...
np.save('Encoder/ft_encoder.npy', label_encoder.classes_)
