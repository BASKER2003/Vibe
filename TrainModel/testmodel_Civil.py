...
# Load dataset
career = pd.read_csv(r'Dataset/CIVIL.data')
...
career.columns = [
    ...
    "Materials Engineering (as applied to civil infrastructure)",
...
np.save('Encoder/civil_encoder.npy', label_encoder.classes_)
...
model.save('SavedModel/Civil.h5')
