...
$username_err = $email_err = $new_password_err = $confirm_password_err = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_check_username = "SELECT username FROM users WHERE username = ? and email = ?";
    if ($stmt_check_username = mysqli_prepare($link, $sql_check_username)) {
        // Bind variables to the prepared statement as parameters
        mysqli_stmt_bind_param($stmt_check_username, "ss", $param_username, $param_email);
    ...
    // Continue with the password reset process if the username is valid
